...
/**
 * Bunu bir ayarüz olarak kullanabilir miyim merak ediyorum
 */
public class Login {
    String type;
    JFrame frame;
     ...
     */
    private boolean enter(int Id,String pass) {

        try {
            String userType = type.substring(0,3).toLowerCase();
                ...
                if (rs.getString(1).equals(pass)){
                    switch (type){
                        case("Patient"):
                            ...
                            break;
                        case("Doctor"):
                            DoctorView doctorView = new DoctorView(Id);
                            break;
                        case("Nurse"):
